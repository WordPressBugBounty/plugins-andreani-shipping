...
class Andreani_Pyme_Api extends Andreani_Base_Api {
	const SHIPPING_METHOD_PREFIX = 'andreani_pyme_';
	const CLIENT_INFO_OPTION     = 'andreani_pyme_info';
	protected static $client_type = 'pyme';
	...
	protected function get_contract_for_delivery_mode( $delivery_mode ) {
		...
		return new WP_Error(
			...
			'El modo de entrega no está configurado en los contratos de Andreani Pyme'
		);
	}
